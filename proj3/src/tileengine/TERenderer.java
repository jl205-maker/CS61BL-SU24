...
public class TERenderer implements Serializable {
    ...
    private static final Font fontMedium = new Font("Monaco", Font.PLAIN, 40); //menu and prompt msg font
     ...
     */
    public void initialize(World world, int w, int h, int xOff, int yOff) {
        this.width = w;
        this.height = h;
        this.xOffset = xOff;
        this.yOffset = yOff;
     ...
     * @param h height of the window in tiles.
     */
    public void initialize(World world, int w, int h) {
        initialize(world, w, h, 0, 0);
    }
     ...
     */
    public void renderFrame(World world, String displayMode) {
        ...
        StdDraw.textLeft(1, this.height - 1, "Language: " + DEFAULT_lANGUAGE);
        StdDraw.textRight(this.width - 1, this.height - 1, "Display Mode: " + displayMode);
        drawTiles(world.getWorld());
        StdDraw.show();
    }
